...
<body>
    <div class="wrapper">
    <?php
    //welcome the researcher if they get access to log in and present information for the user
    echo "<br> Welcome Researcher! <br>";
    echo "You're email is: " . $_SESSION['email'] . ".<br><brb>";
    echo "<br>Click on your patient(s) name below to view their files and  activity information:<br>";
    echo "<br><a href='http://localhost:8888/patient2.php'> Patient 2: Name<br>";

    echo "<br>";
    echo "Click ";
    echo "<a href='http://localhost:8888/PD_news.php'>HERE </a>";
    echo "for the latest news about Parkinson Disease.";
    ?>
    </div>
    </body>
</html>
